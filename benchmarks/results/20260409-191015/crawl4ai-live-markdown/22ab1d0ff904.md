SubscribeSign in
Discover more from Turing Post
Join over 95,000 readers for in-depth knowledge and forward-thinking analysis, to make smarter decisions about AI & ML.
Already have an account? Sign in
# Inside Reflection AI: The $20B Open-Model Startup That Has Yet to Ship
### Why the West may want Reflection AI, and why that still does not mean Reflection AI will make it
Mar 10, 2026
Share
## **Intro**
...
**In today’s episode:**
  * _Starting point of Reflection AI_
  * _From autonomous coding to the “missing Western open model”_
  * _“$2 billions later…” What Reflection has actually built so far_
  * _What “open” means here, and what it does not_
  * _Can Reflection realistically beat closed labs and Chinese contenders?_
  * _Business strategy: Sovereignty, enterprises, and governments_
  * _How big is the sovereign AI market, really?_
  * _What would make the strategy more believable_
  * _Conclusion_
  * _Bonus: Resources_
...
[FOD#135: What It Means When AI Labs Step Into Healthcare](https://turingpost.substack.com/p/fod135-what-it-means-when-ai-labs)
[plus robots from CES](https://turingpost.substack.com/p/fod135-what-it-means-when-ai-labs)
Jan 13
[FOD#137: From Model-Centric to Systems-Level Thinking About Agentsd](https://turingpost.substack.com/p/fod137-from-model-centric-to-systems)
[How agentic AI shifts toward memory management, tool control, and system-level discipline](https://turingpost.substack.com/p/fod137-from-model-centric-to-systems)
Jan 29
[AI 101: What is LeJEPA? The Theory Upgrade JEPA Has Been Missing](https://turingpost.substack.com/p/ai-101-what-is-lejepa-the-theory)
[We discuss how Yann LeCun and Randall Balestriero's latest research drives JEPA foundations and puts it into solid, meaningful practice – and what it…](https://turingpost.substack.com/p/ai-101-what-is-lejepa-the-theory)
Nov 24, 2025
See all
### Ready for more?
© 2026 Ksenia Se[Privacy](https://substack.com/privacy)[Terms](https://substack.com/tos)[Collection notice](https://substack.com/ccpa#personal-data-collected)
