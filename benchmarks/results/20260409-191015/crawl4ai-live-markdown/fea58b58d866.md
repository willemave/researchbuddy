# [Ravi on Product](https://blog.ravi-mehta.com/)
SubscribeSign in
Discover more from Ravi on Product
Reflections on building products & teams people love.
...
Jan 29, 2026
Share
_I'm excited to share this guest post from the product team at Productboard. As they've evolved their platform around AI (first with Pulse, now with Spark), they've accumulated hard-won lessons about building AI-powered products customers love. Two insights stood out to me: first, their distinction between guiding and automating (users say they want AI to do tasks for them, but the real value is in AI that helps them think better). Second, their framing of AI quality as a "third dimension" that breaks traditional product development: you might build the UI and backend in two weeks, then spend two months iterating on AI quality. It's one of the more practical pieces I've seen on building AI that consistently delivers._
...
Here’s what we’ve learned from building Spark, organized around three critical questions:
  1. **How do you know you’re building the right thing?** We’ll cover evaluating AI use cases, the difference between guiding and automating, why _how_ you build matters as much as _what_ you build, and why you need to build ahead of customer readiness.
...
Traditional product development is deterministic. You build a feature, test it, and it behaves the same way every time. AI is fundamentally different. The same input can produce different outputs. This non-determinism creates a new challenge: before you can decide _where_ to apply AI, you first have to understand _what it can reliably do_. That became our first major hurdle.
So how do you approach this?
### Start with the customer problem, then validate AI fit
...
### Ask: Are we guiding or automating?
...
> _— Hubert Palan, Founder & CEO, Productboard_
...
### Match your interface to how users actually work
...
### Rethink workflows, don’t bolt AI onto old ones
...
> _— Dominik Ilichman, Senior AI Product Manager, Productboard_
...
### The hardest decision: Building ahead of your customers
...
## How do you ship fast without sacrificing quality?
...
### An example framework: Three quality thresholds
...
### The third dimension: AI quality
...
### How to systematically improve quality
...
### Remember: Nobody has this figured out
...
## How do you structure teams that scale?
...
### Phase 1: Small core team (3-5 people)
...
### Phase 2: Scaling team (10-15 people)
...
### Phase 3: Specialized teams (20-30+ people)
...
Thanks for reading Ravi on Product! Subscribe for free to receive new posts and support my work.
Share
A guest post by |  VP of Growth and Product at Productboard | ex-SurveyMonkey | [Subscribe to Jordan](https://jordannolff.substack.com/subscribe)  
---|---  
#### Discussion about this post
CommentsRestacks
[Feb 1](https://blog.ravi-mehta.com/p/building-ai-products-lessons-from/comment/208368787 "Feb 1, 2026, 7:32 AM")
Really enjoyed this, thank you for writing it. I’ve seen firsthand how underestimated this challenge is — the hard call of building for early adopters while supporting a customer base that isn’t ready yet.
TopLatestDiscussions
### Ready for more?
© 2026 Ravi Mehta[Privacy](https://substack.com/privacy)[Terms](https://substack.com/tos)[Collection notice](https://substack.com/ccpa#personal-data-collected)
